...
def run_trading_simulation(RR, win_rate, risk_per_trade, total_trades, initial_balance, num_simulations, image_config, save_location):
    ...
    logging.info(f"Results saved as {save_location}")
    plt.show()
    ...
    def run_simulation(self):
        try:
            ...
            save_location = filedialog.asksaveasfilename(
                ...
                title="Choose where to save the simulation results"
            )

            if save_location:  # Only run if user didn't cancel
                # Run the trading simulation
                run_trading_simulation(RR, win_rate, risk_per_trade, total_trades, initial_balance, 
                                    self.num_simulations, self.image_config, save_location)

                # Show a success message
                messagebox.showinfo("Simulation Complete", f"The simulation has completed successfully!\nResults saved to: {save_location}")
            else:
